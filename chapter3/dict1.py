# collections.abc содержит абстрактные базовые классы Mapping и MutableMapping, формализующие интерфейсы типа dict и родственных ему
from collections import abc, OrderedDict

my_dict = {}

# В тестах использовать isinstance лучше, чем проверять принадлежит ли аргумент функции типу dict, потому что допустимы так же другие типы
